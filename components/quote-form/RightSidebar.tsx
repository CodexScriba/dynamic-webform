        ...
        {FEATURES.map(({ icon: Icon, title, description }) => (
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-[14px] leading-relaxed text-white/90">{description}</p>
            </div>
          </div>
        ))}
      </div>
    ...
    <>
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="rounded-lg bg-white/10 p-4 border border-white/20">
              <p className="text-sm font-semibold text-white mb-2">Platform Options</p>
              <p className="text-xs text-white/85 leading-relaxed">
      ...
      {serviceType === 'otp' && (
        <div className="mt-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="rounded-lg bg-white/10 p-4 border border-white/20">
              <p className="text-sm font-semibold text-white mb-2">Environment Setup</p>
              <p className="text-xs text-white/85 leading-relaxed">
      ...
      {serviceType === 'onsite' && (
        <div className="mt-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="rounded-lg bg-white/10 p-4 border border-white/20">
              <p className="text-sm font-semibold text-white mb-2">Location Information</p>
              <p className="text-xs text-white/85 leading-relaxed">
  ...
  return (
    <>
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="rounded-lg bg-white/10 p-4 border border-white/20">
          <p className="text-sm font-semibold text-white mb-2">Point of Contact</p>
          <p className="text-xs text-white/85 leading-relaxed">
        ...
        <div className="rounded-lg bg-white/10 p-4 border border-white/20">
          <p className="text-sm font-semibold text-white mb-2">Provider Information</p>
          <p className="text-xs text-white/85 leading-relaxed">
      ...
      <div className="mt-6 rounded-lg border-2 border-green-400/30 bg-green-400/10 p-4">
        <p className="text-sm font-semibold text-white mb-1">Progress Update</p>
        <p className="text-xs text-white/90">
          Great progress! Just billing details and final review remaining.
        </p>
      </div>
    </>
  )
  ...
  return (
    <>
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="rounded-lg bg-white/10 p-4 border border-white/20">
          <p className="text-sm font-semibold text-white mb-2">Cost Center</p>
          <p className="text-xs text-white/85 leading-relaxed">
      ...
      <div className="mt-6 rounded-lg border-2 border-amber-400/30 bg-amber-400/10 p-4">
        <p className="text-sm font-semibold text-white mb-1">Almost Done!</p>
        <p className="text-xs text-white/90">
  ...
  return (
    <>
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="rounded-lg bg-white/10 p-4 border border-white/20">
          <p className="text-sm font-semibold text-white mb-2">Need Changes?</p>
          <p className="text-xs text-white/85 leading-relaxed">

...
import { Calendar, Clock, Globe, Link as LinkIcon, Phone as PhoneIcon, Video, MapPin } from 'lucide-react'
...
interface Page2ServiceAppointmentProps {
  form: UseFormReturn<QuoteFormSchema>
}

export function Page2ServiceAppointment ({ form }: Page2ServiceAppointmentProps) {

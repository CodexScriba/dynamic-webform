  ...
  return (
    <div className='space-y-6'>
      <section className='space-y-4'>
        <div>
          <h2 className='text-2xl font-semibold text-[#002060]'>Request a Quote</h2>
          <p className='text-sm text-slate-500'>Connect with our expert team for professional language services</p>
        </div>
              ...
              <FormItem className='space-y-2'>
                ...
                <FormControl>
                  <div className='relative'>
                    ...
                    <Input {...field} className='h-11 rounded-2xl border-none bg-slate-50 pl-12 pr-4 text-sm shadow-inner focus-visible:ring-2 focus-visible:ring-[#FF9500]/40 focus-visible:ring-offset-0' placeholder='Healthcare network, hospital, or clinic' />
                  </div>
                </FormControl>
                <FormMessage />
              </FormItem>
          ...
          <Controller
            ...
            render={({ field }) => (
              <FormItem className='flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3 shadow-inner'>
                <div>
                  <FormLabel className='text-sm font-semibold text-[#002060]'>Do you have an account with us?</FormLabel>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='space-y-2'>
                ...
                <FormControl>
                  <div className='relative'>
                    <Input {...field} className='h-11 rounded-2xl border-none bg-slate-50 pl-4 pr-4 text-sm shadow-inner focus-visible:ring-2 focus-visible:ring-[#FF9500]/40 focus-visible:ring-offset-0' placeholder='Enter your existing Client ID' />
                  </div>
                </FormControl>
              </FormItem>
            )}
              ...
              <FormItem className='space-y-2'>
                ...
                <FormControl>
                  <div className='relative'>
                    ...
                    <Input {...field} className='h-11 rounded-2xl border-none bg-slate-50 pl-12 pr-4 text-sm shadow-inner focus-visible:ring-2 focus-visible:ring-[#FF9500]/40 focus-visible:ring-offset-0' placeholder='Full name' />
                  </div>
                </FormControl>
                <FormMessage />
              </FormItem>
              ...
              <FormItem className='space-y-2'>
                ...
                <FormControl>
                  <div className='relative'>
                    ...
                    <Input {...field} className='h-11 rounded-2xl border-none bg-slate-50 pl-12 pr-4 text-sm shadow-inner focus-visible:ring-2 focus-visible:ring-[#FF9500]/40 focus-visible:ring-offset-0' placeholder='name@organization.com' />
                  </div>
                </FormControl>
              </FormItem>
            )}
              ...
              <FormItem className='space-y-2'>
                ...
                <FormControl>
                  <div className='relative'>
                    ...
                    <Input {...field} className='h-11 rounded-2xl border-none bg-slate-50 pl-12 pr-4 text-sm shadow-inner focus-visible:ring-2 focus-visible:ring-[#FF9500]/40 focus-visible:ring-offset-0' placeholder='(555) 000-1234' />
                  </div>
                </FormControl>
              </FormItem>
            )}
              ...
              {SERVICE_TYPE_OPTIONS.map(option => {
                ...
                return (
                  <motion.button
                    ...
                    className={cn(
                      cardBaseClasses,
                      isSelected ? 'border-[#FF9500] shadow-[0_12px_24px_rgba(255,149,0,0.15)]' : 'hover:border-[#FF9500]/50'
                    )}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.98 }}
                  >
